...
async def main():
    ...
    await multitask(
        ...
        bot.straight_at_speed(230, speed=300, acceleration=150),
    )
    ...
    await right_motor.run_target(200, -310)
    ...
    await multitask(
        wait(2000),
        left_motor.run_until_stalled(-300, Stop.HOLD, 80),
        race=True,
    )
